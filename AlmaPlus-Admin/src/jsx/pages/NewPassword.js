...
function NewPassword() {
    ...
    const submitHandler = (e) => {
        ...
        if (validate()) {
            setDisable(true);
            const myurl = `${ALMA_PLUS_API_URL}/api/resetpassword?token=${token}`;
            axios({
                method: "post",
                url: myurl,
                data: {
            ...
            <div id="page-container" className="fade">
                <div className="login login-v2">
                    <div className="login-header">
                        <div className="brand">
                            <span className="logo"></span> <b>AlmaPlus</b> Admin
                            <small>Forgot Password for AlmaPlus admin panel</small>
                        </div>
                        <div className="icon">
